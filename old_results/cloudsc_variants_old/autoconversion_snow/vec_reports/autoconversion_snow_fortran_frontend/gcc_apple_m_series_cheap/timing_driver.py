...
sdfg.build_folder = str(pathlib.Path(r'cloudsc_variants/autoconversion_snow/vec_reports/autoconversion_snow_fortran_frontend/gcc_apple_m_series_cheap/build'))
