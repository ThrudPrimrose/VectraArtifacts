...
sdfg.build_folder = str(pathlib.Path(r'cloudsc_variants/saturation_calculation/vec_reports/saturation_calculation_fortran_frontend/gcc_apple_m_series_disabled/build'))
