import json, re, sys
import numpy as np
sys.path.insert(0, r'cloudsc_variants/saturation_calculation')
import run_saturation_calculation as mod
mod.HERE = r'cloudsc_variants/saturation_calculation/vec_reports/fortran/saturation_calculation/clang_apple_m_series_unlimited'
