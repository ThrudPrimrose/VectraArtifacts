import json, re, sys
import numpy as np
sys.path.insert(0, r'cloudsc_variants/lu_solver')
import run_lu_solver as mod
mod.HERE = r'cloudsc_variants/lu_solver/vec_reports/fortran/lu_solver/clang_apple_m_series_unlimited'
