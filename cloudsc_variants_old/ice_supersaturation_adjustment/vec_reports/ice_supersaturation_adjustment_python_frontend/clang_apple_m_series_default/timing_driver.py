...
sdfg.build_folder = str(pathlib.Path(r'cloudsc_variants/ice_supersaturation_adjustment/vec_reports/ice_supersaturation_adjustment_python_frontend/clang_apple_m_series_default/build'))
