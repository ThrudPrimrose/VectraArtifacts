...
sdfg.build_folder = str(pathlib.Path(r'cloudsc_variants/autoconversion_snow/vec_reports/autoconversion_snow_python_frontend/clang_apple_m_series_cheap/build'))
