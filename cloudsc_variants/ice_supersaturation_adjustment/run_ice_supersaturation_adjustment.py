...
# ice_supersaturation_adjustment's python-frontend SDFG declares its two
# multi-dimensional arrays (zsolqa, zqxfg) axis-reversed so KLON lands at unit
# stride under DaCe's default C-contiguous storage -- see
# ice_supersaturation_adjustment_dace.py's module docstring and
