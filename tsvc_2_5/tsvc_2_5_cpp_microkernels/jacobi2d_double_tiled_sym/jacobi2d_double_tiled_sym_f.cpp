...
// jacobi2d_double_tiled_sym_f: two-level Jacobi with symbolic outer t1 and inner t2
void jacobi2d_double_tiled_sym_f(float *__restrict__ b, const float *__restrict__ a, const int len_2d,
