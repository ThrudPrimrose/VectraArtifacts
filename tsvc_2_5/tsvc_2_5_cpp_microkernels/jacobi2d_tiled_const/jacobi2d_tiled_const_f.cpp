...
// jacobi2d_tiled_const_f: 2D 5-point Jacobi pre-tiled with constant tile size 64
void jacobi2d_tiled_const_f(float *__restrict__ b, const float *__restrict__ a, const int len_2d,
