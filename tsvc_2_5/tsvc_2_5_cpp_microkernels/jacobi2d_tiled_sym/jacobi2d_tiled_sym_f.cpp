...
// jacobi2d_tiled_sym_f: 2D 5-point Jacobi pre-tiled with symbolic tile size t
void jacobi2d_tiled_sym_f(float *__restrict__ b, const float *__restrict__ a, const int len_2d, const int t,
