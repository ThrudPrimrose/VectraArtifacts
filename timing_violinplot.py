#!/usr/bin/env python3
"""
timing_violinplot.py
-----------------------
Reads all timing_report.csv files from a results directory tree and produces
violin-plot PNGs per kernel × precision, with DaCe and CPP backends shown
...
def plot_kernel_precision(
    ...
    meta = {
        ...
        "description": (
            f"Violin plot of {kernel} ({precision}) execution time "
...
def parse_args(argv=None):
    ap = argparse.ArgumentParser(description="Per-kernel violin-plot sweep visualiser.")
