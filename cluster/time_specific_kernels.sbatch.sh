...
# sbatch copies this script into a spool dir and runs it FROM THERE, so
# ${BASH_SOURCE[0]} (and, under this --uenv setup, $SLURM_SUBMIT_DIR too)
# don't reliably point back at the checkout -- just hardcode it.
ROOT="$HOME/VectraArtifacts"
cd "$ROOT"
